...
**Update (same day): Rick also asked whether any speakers published with CRC Press. None did.** Zero of the 14 identified books trace to CRC Press (or its parent, Routledge/Taylor & Francis) — confirmed by direct searches pairing each unresolved-publisher title (*RipTide*, *Cybersecurity's Dirty Secret*, *Committed*, *Architecting Success*) against "CRC Press" specifically, on top of the publisher identifications already made below. CRC Press does publish cybersecurity technical books generally (its Routledge catalog includes series like *Cyber Shorts* and *Advances in Cybersecurity Management*), it just doesn't happen to publish any title on this particular speaker roster.
...
- CRC Press cross-checks (added same day, Update Pass): targeted searches pairing *RipTide*, *Cybersecurity's Dirty Secret*, *Committed*, and *Architecting Success* against "CRC Press" by name — no matches found for any title on the roster. [Routledge/CRC Press's own cybersecurity book-series pages](https://www.routledge.com/Cyber-Shorts/book-series/CYBSH) confirmed as a real, active catalog (ruling out "CRC Press doesn't publish this kind of book" as an explanation), just not one represented on this speaker list.
