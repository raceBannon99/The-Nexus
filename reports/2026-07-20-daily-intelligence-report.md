...
*Update (same day, post-publish): Rick flagged that the APT42/TAMECAT item was under-tagged — it was originally filed as generic "Iran" nation-state activity, but its March-2026 targeting tied to the US-Israel strikes on Iran is a direct hit on the CIR's explicitly named "The US - Israel - Iran Cyber War" watch item. The Nation-State & Adversary Activity entry below has been corrected to reflect that tag.*
...
- **Iran — The US-Israel-Iran Cyber War.** APT42 (aka TA453), an Iran-linked espionage group, is running the "SpearSpecter" campaign against senior defense and government officials, using AI-assisted phishing (persona development, translation, malware engineering) and an upgraded "TAMECAT" backdoor with browser-credential and Outlook-mailbox harvesting plus HTTPS/Discord/Telegram C2 channels. The analysis ties this directly to the active conflict: March 2026 targeting coincided with US-Israel strikes on Iran, with focus specifically on air-defense intelligence relevant to that fight — a direct hit on the CIR's explicitly named "US-Israel-Iran Cyber War" watch item, not just a generic Iran nation-state tag. *(Gmail/Google Alert → DarkAtlas research blog, July 19)* → [APT42: AI-Assisted Phishing and the Resilient TAMECAT Backdoor](https://darkatlas.io/blog/apt42-ai-assisted-phishing-tamecat-analysis)
