...
flowchart TD
    ...
    F --> G["Aeaea (Circe)<br/>Lost: 1 (Elpenor, accident)"]
    G --> H["The Underworld<br/>Lost: 0 — meets Tiresias, Anticleia,<br/>Achilles, Agamemnon, Ajax"]
    ...
    class C,E,H,I,J,M,N,O safe;
    class B,D,G,K costly;
