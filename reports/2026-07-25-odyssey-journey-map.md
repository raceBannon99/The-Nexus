...
6. **Aeaea (Circe) — the pig episode, added 2026-07-25.** Odysseus splits his crew and sends a 22-man scouting party, led by Eurylochus, to investigate; Circe (a sorceress-goddess, daughter of the sun god Helios) drugs and transforms 21 of them into pigs. Eurylochus alone held back, suspected a trap, and escaped to warn Odysseus. Hermes intercepts Odysseus on the way and gives him a protective herb (moly); protected from Circe's magic, Odysseus forces her to swear an oath and restore his men. She does — Homer states they emerge from the transformation "younger and more handsome" than before. **No one dies in this episode; all 21 are fully restored.**
7. **Aeaea (Circe) — Elpenor's death, near the end of the year-long stay.** No permanent deaths from the pig episode above — but the youngest crewman, **Elpenor**, dies here separately, in a mundane accident (drunk, falls off Circe's roof, breaks his neck) just before the ship departs for the Underworld.
8. **The Underworld (the Nekyia)** — Odysseus travels to the edge of Hades to consult the prophet **Tiresias** about the way home. He also meets the shade of **Elpenor** (who begs for burial), his mother **Anticleia**, and the shades of **Achilles**, **Agamemnon**, and **Ajax**, among others. No new deaths among his living crew — this is a conversation with the already-dead, not a new hazard.
9. **Back to Aeaea, briefly** — the crew returns to Circe's island to properly cremate and bury Elpenor, per his request, before continuing home.
10. **The Sirens** — no deaths. Odysseus has himself lashed to the mast to hear their song safely; his crew's ears are sealed with beeswax.
11. **Scylla and Charybdis** — Circe had warned Odysseus in advance to choose Scylla (a six-headed monster) over Charybdis (a ship-swallowing whirlpool), since losing a few men to Scylla is survivable and Charybdis is not. Scylla seizes and eats six men. Charybdis is successfully avoided on this pass.
12. **Thrinacia (the Cattle of Helios)** — becalmed and starving, the crew ignores Odysseus's direct warning (relayed from both Circe and Tiresias) and kills and eats some of the sun god Helios's sacred, immortal cattle. Helios demands justice from Zeus. When they finally sail, **Zeus destroys the ship with a thunderbolt**, killing every remaining man except Odysseus, who survives by clinging to wreckage.
13. **Ogygia (Calypso)** — Odysseus, now entirely alone, washes up on the nymph-goddess Calypso's island and is held there for **seven years**, with Calypso offering him immortality and marriage if he stays. He refuses. Zeus eventually sends **Hermes** to order her to let him go.
14. **Scheria (the Phaeacians)** — shipwrecked again during the crossing (Poseidon's doing, still angry), Odysseus washes ashore alone and is found by the princess **Nausicaa**. He's welcomed at the court of **King Alcinous** and **Queen Arete**, where he tells the entire flashback story above (Books 9–12) before the Phaeacians give him safe, magical passage home.
15. **Ithaca** — Odysseus arrives home alone, disguised by Athena as a beggar. He's recognized by his old nurse **Eurycleia** and his dog Argos, reunites with his son **Telemachus**, and with help from the loyal swineherd **Eumaeus**, kills the **108 suitors** who had been occupying his hall and pressuring his wife **Penelope** to remarry, believing him dead. His father **Laertes** appears at the very end. *Note: the suitors are not "his men" — they're the story's antagonists, killed by Odysseus rather than lost alongside him — worth keeping distinct from the crew-death count above.*
...
flowchart TD
    ...
    E --> F["Laestrygonians<br/>Lost: 11 of 12 ships<br/>(the overwhelming majority of the fleet)"]
    F --> G1["Aeaea (Circe) — arrival<br/>21 of 22 scouts turned to swine,<br/>then fully restored<br/>Lost: 0"]
    G1 --> G2["Aeaea (Circe) — Elpenor's death<br/>(accident, eve of departure)<br/>Lost: 1"]
    G2 --> H["The Underworld<br/>Lost: 0 — meets Tiresias, Anticleia,<br/>Achilles, Agamemnon, Ajax"]
    H --> I["Back to Aeaea<br/>Elpenor buried; Lost: 0"]
    I --> J["Sirens<br/>Lost: 0"]
    J --> K["Scylla &amp; Charybdis<br/>Lost: 6 to Scylla<br/>Charybdis avoided"]
    K -->|"all remaining men die here"| L["Thrinacia<br/>Cattle of Helios eaten;<br/>Zeus destroys the ship —<br/>Lost: everyone but Odysseus"]
    L -->|"Odysseus now completely alone"| M["Ogygia (Calypso)<br/>7 years captive; Lost: n/a — alone"]
    M --> N["Scheria (Phaeacians)<br/>Alcinous, Arete, Nausicaa<br/>Lost: n/a — alone"]
    N --> O["ITHACA<br/>Reunites with Telemachus, Penelope,<br/>Eumaeus, Eurycleia, Laertes<br/>Kills 108 suitors (not his own men)"]

    classDef safe fill:#1c1c1e,stroke:#38383a,color:#f5f5f7;
    classDef costly fill:#1c2e38,stroke:#3b5a6e,color:#f5f5f7;
    classDef catastrophic fill:#3a1f1f,stroke:#7a3b3b,color:#f5f5f7;
    class C,E,H,I,J,M,N,O,G1 safe;
    class B,D,G2,K costly;
...
| 6 | Aeaea (Circe) — arrival; **men turned to swine, then restored** | Year 11–12 (early in the "full year" stay) | Circe — sorceress-goddess of magic and transformation, daughter of Helios; Hermes — messenger god, guide of travelers, gives Odysseus the protective herb moly | Circe (Sorceress-Queen of Aeaea) | 0 died — but 21 of a 22-man scouting party (led by Eurylochus, who alone escaped) were drugged and transformed into pigs; Odysseus, protected by moly, forces Circe to restore them, and Homer states they emerged "younger and more handsome" than before | ~43 (unchanged — all 21 restored, none lost) | T1 |
| 7 | Aeaea (Circe) — Elpenor's death, eve of departure | Year 12 (end of the "full year" stay) | Circe | Circe (Sorceress-Queen of Aeaea) | 1 (Elpenor — accident, not a monster) | ~43 | T1 |
| 8 | The Underworld | Year 12 (early) | (the realm of Hades and Persephone; neither acts directly on-page) | Tiresias (blind Prophet of Thebes), Anticleia (his mother, Queen of Ithaca by marriage), Elpenor's shade, Achilles, Agamemnon (King of Mycenae), Ajax (Greek heroes of Troy) | 0 (the already-dead, not a new hazard) | ~43 | T1 |
| 9 | Aeaea (return) | Year 12 | Circe | Circe (Sorceress-Queen of Aeaea) | 0 (Elpenor's funeral) | ~43 | T1 |
| 10 | The Sirens | Year 12 | — | The Sirens — monstrous singing creatures | 0 | ~43 | T1 |
| 11 | Scylla & Charybdis | Year 12 | — | Scylla (six-headed sea monster), Charybdis (monstrous whirlpool) | 6 (to Scylla, explicit; Charybdis avoided) | ~37 | T1 |
| 12 | Thrinacia | Year 12–13 (includes the "month" stranded) | Helios — god of the sun, owner of the cattle; Zeus — king of the gods, god of sky and thunder, executes judgment | — | ~37 ("all but Odysseus," per text) | 0 | T1 for the outcome, T2 for the number |
| 13 | Ogygia (Calypso) | Years 13–19 (the stated "seven years") | Calypso — a nymph/minor goddess, daughter of the Titan Atlas; Hermes — messenger god, delivers Zeus's order to release him | Calypso (Nymph of Ogygia) | n/a — already alone | 0 | T1 |
| 14 | Scheria (Phaeacians) | Year 20 (the stated "17 days" raft, then arrival) | Athena — goddess of wisdom and strategy, in disguise as a guide | Nausicaa (Princess of the Phaeacians), Alcinous (King of the Phaeacians), Arete (Queen of the Phaeacians) | n/a — alone | 0 | T1 |
| 15 | Ithaca (return) | Year 20 (arrival) | Athena — goddess of wisdom and strategy | Telemachus (Prince of Ithaca, his son), Penelope (Queen of Ithaca, his wife), Eumaeus (his loyal swineherd), Eurycleia (his old nurse), Laertes (his father, former King of Ithaca) | 0 of his own men; **108 suitors killed separately** (antagonists — see note below) | 0 | T1 for "0 of his own men"; T2 for "108" |
...
- [Theoi Classical Texts Library — Odyssey Book 10](https://www.theoi.com/Text/HomerOdyssey10.html) and cross-checked secondary summaries (SparkNotes, LitCharts, Shmoop Book 10 guides) — confirms the 22-man scouting party, 21 transformed to swine, Eurylochus's escape, Hermes/moly, and the men's restoration "younger and more handsome" than before.
